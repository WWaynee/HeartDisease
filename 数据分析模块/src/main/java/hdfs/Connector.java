...
public class Connector {
  ...
  private static final String HADOOP_HOME = "/Users/jabin/code/hadoop/bina";
  ...
  public void listFiles() throws IOException {
    ...
    while (remoteIterator.hasNext()) {
      ...
      logger.info(fileStatus.getPath().getName() + "   " + fileStatus.getBlockSize() + "   "
          + fileStatus.getPermission() + "  " + fileStatus.getLen());
    }
  }
  ...
  private void test_downloadFiles(Connector connector) {
    ...
    String dest = "/Users/jabin/code/hadoop/down";
    try {
